...
+ **compressimg.sh** >> Uses `imagemagick` to batch compress images....
+ **compressimg.py** >> Same as above but written in python....
...
+ **imagerotate** >> A script to rotate or flip multiple images, overwriting the original files....
