...
mkdir dwm && cd dwm/ && wget https://dl.suckless.org/dwm/dwm-6.2.tar.gz && tar xvzf dwm-6.2.tar.gz && cd dwm-6.2 && make && make install && cd .. && \
mkdir st && cd st/ && wget https://dl.suckless.org/st/st-0.8.3.tar.gz && tar xvzf st-0.8.3.tar.gz && cd st-0.8.3 && make && make install && cd .. && \
mkdir dmenu && cd dmneu/ && wget https://dl.suckless.org/tools/dmenu-4.9.tar.gz && tar xvzf dmenu-4.9.tar.gz && cd dmenu-4.9 && make && make install && cd .. && \
mkdir slock && cd slock/ wget https://dl.suckless.org/tools/slock-1.4.tar.gz && tar xvzf slock-1.4.tar.gz && cd slock-1.4 && make && make install && cd .. && \
