...
mkdir /home/furycd001/.src/ && cd /home/furycd001/.src/ && cd .src/ && \
mkdir dwm && cd dwm/ && wget https://dl.suckless.org/dwm/dwm-6.2.tar.gz && make && make install && cd .. && \
mkdir st && cd st/ && wget https://dl.suckless.org/st/st-0.8.3.tar.gz && make && make install && cd .. && \
mkdir dmenu && cd dmneu/ && wget https://dl.suckless.org/tools/dmenu-4.9.tar.gz && make && make install && cd .. && \
mkdir slock && cd slock/ wget https://dl.suckless.org/tools/slock-1.4.tar.gz && make && make install && cd .. && \
